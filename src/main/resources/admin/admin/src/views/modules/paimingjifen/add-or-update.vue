<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="计分编号" prop="jifenbianhao">
            <el-input v-model="ruleForm.jifenbianhao" 
                placeholder="计分编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jifenbianhao" label="计分编号" prop="jifenbianhao">
              <el-input v-model="ruleForm.jifenbianhao" 
                placeholder="计分编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="比赛得分" prop="bisaidefen">
          <el-input v-model="ruleForm.bisaidefen" 
              placeholder="比赛得分" clearable  :readonly="ro.bisaidefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="比赛得分" prop="bisaidefen">
              <el-input v-model="ruleForm.bisaidefen" 
                placeholder="比赛得分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="计分时间" prop="jifenshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jifenshijian" 
                type="date"
                :readonly="ro.jifenshijian"
                placeholder="计分时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jifenshijian" label="计分时间" prop="jifenshijian">
              <el-input v-model="ruleForm.jifenshijian" 
                placeholder="计分时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="裁判账号" prop="caipanzhanghao">
          <el-input v-model="ruleForm.caipanzhanghao" 
              placeholder="裁判账号" clearable  :readonly="ro.caipanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="裁判账号" prop="caipanzhanghao">
              <el-input v-model="ruleForm.caipanzhanghao" 
                placeholder="裁判账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="裁判姓名" prop="caipanxingming">
          <el-input v-model="ruleForm.caipanxingming" 
              placeholder="裁判姓名" clearable  :readonly="ro.caipanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="裁判姓名" prop="caipanxingming">
              <el-input v-model="ruleForm.caipanxingming" 
                placeholder="裁判姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.jifenshijian = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='jifenbianhao'){
            this.ruleForm.jifenbianhao = obj[o];
	    this.ro.jifenbianhao = true;
            continue;
          }
          if(o=='bisaidefen'){
            this.ruleForm.bisaidefen = obj[o];
	    this.ro.bisaidefen = true;
            continue;
          }
          if(o=='paiming'){
	    ...
	    this.ro.paiming = true;
          ...
          if(o=='jifenshijian'){
            this.ruleForm.jifenshijian = obj[o];
	    this.ro.jifenshijian = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.caipanzhanghao = true;
          ...
          if(o=='caipanxingming'){
            this.ruleForm.caipanxingming = obj[o];
	    this.ro.caipanxingming = true;
            continue;
          }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.caipanzhanghao!=''&&json.caipanzhanghao){
                this.ruleForm.caipanzhanghao = json.caipanzhanghao
	    		this.ro.caipanzhanghao = true;
		}
		if(json.caipanxingming!=''&&json.caipanxingming){
                this.ruleForm.caipanxingming = json.caipanxingming
	    		this.ro.caipanxingming = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `paimingjifen/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.paimingjifenCrossAddOrUpdateFlag = false;
						 this.parent.search();
