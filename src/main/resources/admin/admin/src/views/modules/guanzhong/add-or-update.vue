<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="观众账号" prop="guanzhongzhanghao">
          <el-input v-model="ruleForm.guanzhongzhanghao" 
              placeholder="观众账号" clearable  :readonly="ro.guanzhongzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="观众账号" prop="guanzhongzhanghao">
              <el-input v-model="ruleForm.guanzhongzhanghao" 
                placeholder="观众账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="观众姓名" prop="guanzhongxingming">
          <el-input v-model="ruleForm.guanzhongxingming" 
              placeholder="观众姓名" clearable  :readonly="ro.guanzhongxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="观众姓名" prop="guanzhongxingming">
              <el-input v-model="ruleForm.guanzhongxingming" 
                placeholder="观众姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  data() {
	...
	dianhuahaoma : false,
      ...
      rules: {
          guanzhongzhanghao: [
                { required: true, message: '观众账号不能为空', trigger: 'blur' },
          ],
          guanzhongxingming: [
                { required: true, message: '观众姓名不能为空', trigger: 'blur' },
          ],
          mima: [
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `guanzhong/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.guanzhongCrossAddOrUpdateFlag = false;
						 this.parent.search();
